...
import { Box, IconButton, Modal, Paper, Table, TableBody, TableCell, tableCellClasses, TableContainer, TableHead, TableRow } from "@mui/material";
              ...
              (deal: any, index) => (
                <StyledTableRow key={deal._id}>
                  ...
                  <StyledTableCell align="right">
                    <IconButton onClick={handleOpen(deal._id)}>
